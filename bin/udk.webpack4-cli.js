...
Usage: udk [options]
       udk [options] --entry <entry> --output <output>
       udk [options] <entries...> --output <output>
...
For more information, see https://webpack.js.org/api/cli/.`);
	...
	yargs.parse(process.argv.slice(2), (err, argv, output) => {
		...
		function processOptions(options) {
			...
			const statsPresetToOptions = require("../lib/webpack").Stats.presetToOptions;
      ...
      if(!process.send && (firstOptions.watch || options.watch)) {
        ...
        // < webpack-cli/bin/convert-argv.js #100
      ...
      // < Extrem HMR
			...
			if (argv.progress) {
				const ProgressPlugin = require("../lib/webpack").ProgressPlugin;
				new ProgressPlugin({
