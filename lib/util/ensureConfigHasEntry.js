function ensureConfigHasEntry (webpackConfig, entry, entryOptions, options = {}) {
  if (Array.isArray(webpackConfig)) {
    return webpackConfig.forEach((wconfig) => ensureConfigHasEntry(wconfig, entry, entryOptions))
  }

  if (Array.isArray(entry)) {
    return entry.forEach((e) => ensureConfigHasEntry(webpackConfig, e, entryOptions))
  }
